 ...
 *
 * File:          $RCSfile: IDynamicClassProvider.java,v $
 * Version:       $Name:  $ $Revision: 1.1 $
 * Last Modified: $Date: 2005/11/25 12:35:53 $
 *****************************************************************************/
...
public interface IDynamicClassProvider
{
	 ...
	 */
	void registerModule(ModuleDefinition aModule) throws IOException;
	/** Called to unregister a module from potential compilation
	 */
	void unregisterModule(ModuleDefinition aModule) throws IOException;
	/* returns true if any of the registered modules have been
	 * modified in such a way to need recompilation/reloading
	 */
	boolean isModified();
}