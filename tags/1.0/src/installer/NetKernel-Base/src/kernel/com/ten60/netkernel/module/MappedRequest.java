 ...
 *
 * File:          $RCSfile: MappedRequest.java,v $
...
public final class MappedRequest
{
	...
	private List mDebug;
	private int mContextDepth;
	
	/** Creates a new instance of MappedRequest */
	public MappedRequest(String aAccessorClass, URRequest aMappedRequest, int aContextDepth)
	{	mAccessorClass = aAccessorClass;
		mMappedRequest = aMappedRequest;
		mContextDepth = aContextDepth;
	}
