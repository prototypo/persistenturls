 ...
 *
 * File:          $RCSfile: IBreakpoint.java,v $
...
{
	/** If it returns true for the given request state then the request will be placed in a
	 * breakpoint state
	 * @param aState the state to examine
	 * @param aDebugger might be useful
	 */
