 ...
 *
 * File:          $RCSfile: IAspectDBConnectionPool.java,v $
 ...
 * @author  tab
 */
public interface IAspectDBConnectionPool extends IURAspect
{
	final int TIMEOUT_METHOD_SET=0;
	final int TIMEOUT_METHOD_TIMER=1;
	
    Connection acquireConnection() throws NetKernelException;
