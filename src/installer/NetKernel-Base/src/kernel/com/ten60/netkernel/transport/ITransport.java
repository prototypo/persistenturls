 ...
 *
 * File:          $RCSfile: ITransport.java,v $
...
/**
 * A transport encapsulates a mechanism for receiving external requests into the NetKernel
 * and providing replies.
 * @author  tab
 */
public interface ITransport extends IURComponent
{
	/** Change the context of this transport, used in hot restart
	 */
	public void setContext(IRequestorContext aContext);
	/** Return a short description of the transport that may describe relevant configuration
