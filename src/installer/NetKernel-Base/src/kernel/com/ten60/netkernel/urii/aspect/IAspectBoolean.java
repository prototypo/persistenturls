 ...
 *
 * File:          $RCSfile: IAspectBoolean.java,v $
 ...
 * @author  pjr
 */
public interface IAspectBoolean extends IURAspect
{	
	/** mime type for boolean */
	public static final String MIME_TYPE="application/vnd.netkernel-boolean";
