 ...
 *
 * File:          $RCSfile: LogFileHandler.java,v $
...
{	public LogFileHandler(String aPattern, int aLimit, int aCount) throws IOException
	{	super(aPattern.replaceAll("%b",System.getProperty("netkernel.basepath")),aLimit,aCount,false);
	}
}