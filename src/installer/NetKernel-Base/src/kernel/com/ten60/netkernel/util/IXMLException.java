 ...
 *
 * File:          $RCSfile: IXMLException.java,v $
...
public interface IXMLException
{
	 ...
	 * @param aWriter the writer to write exception to
	 * @exception  IOException thrown if we fail to write to writer
	 */
	void appendXML(Writer aWriter) throws IOException;
