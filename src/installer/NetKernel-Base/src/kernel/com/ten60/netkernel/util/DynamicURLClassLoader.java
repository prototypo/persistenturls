 ...
 * Last Modified: $Date: 2008/03/26 10:28:57 $
 *****************************************************************************/
...
public class DynamicURLClassLoader extends ClassLoader
{
	...
	private static Enumeration sEmptyEnum;
	static
	{	sEmptyEnum = new Enumeration()
		{
	...
	/*Cannot override in JDK 1.4.2
	public Enumeration getResources(String aName)
	{	URL resource = getResource(aName);
		if (resource!=null)
