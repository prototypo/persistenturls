...
public class MirrorPURLTest extends TestCase {
	...
	public static abstract class PURLServer implements RDFObject {
		@method("GET")
		@type("message/x-response")
		@cacheControl("max-age=60")
		public HttpResponse get(@parameter("*") String qs,
				@header("Max-Forward") Integer max) throws Exception {
			return resolvePURL(getResource().stringValue(), qs,
					max == null ? 20 : max);
		}

		public abstract HttpResponse resolvePURL(String source, String qs,
	...
	public interface MyServer {
		...
		/**
		 * Description of all PURLs in the given necklace.
		 */
		@operation("purlsOf")
		public GraphQueryResult myPurlsOf(@parameter("box") Object box)
				throws Exception;
	}
