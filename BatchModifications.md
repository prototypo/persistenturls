...
## Logging in and modifying a batch of PURLs ##

### Perl ###
This sample was provided by David Wood.  Please modify the appropriate variables before running. This script provides batch loading of XML files from a directory. See [PURLBatchUploadingVersionOne](PURLBatchUploadingVersionOne.md) for details of the input format.
